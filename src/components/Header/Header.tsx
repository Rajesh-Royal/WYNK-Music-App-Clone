          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            {/* Right side search and */}
             ...
             <div className="text-black flex items-center flex-1 justify-end">
                <div className="border rounded overflow-hidden flex bg-white">
                    <button className="flex items-center justify-center px-1 outline-none">
                        <SearchIcon className="text-gray-500 w-5 mx-2"/>
                    </button>
                    <input
                        type="text"
              ...
              <div className="hidden md:flex items-center ml-4">
                <ToggleDarkMode />
                <img src={isDarkMode ? LanguageWhiteIcon : LanguageIcon} alt="language icon" className="text-gray-500 w-5 mx-4"/>
